...
# CN density plot for all samples
```{r}
ggplot(data=short_phenotype,aes(x=CN)) +
...
#ggsave("plot/03_CN_density.pdf", width = 8, height = 6)
```  

```{r}
ggplot(data=onlyASD,aes(x=CN,fill="onlyASD")) +
  geom_density(alpha=0.6) +
  geom_vline(xintercept=mean(onlyASD$CN), size=0.6, color="#00BFC4") +
  geom_density(data=onlyCancer,aes(x=CN,fill="onlyCancer"),alpha=0.6) +
  geom_vline(xintercept=mean(onlyCancer$CN), size=0.6,color = "#C77CFF") +
  geom_density(data=ASDCancer,aes(x=CN,fill="ASDCancer"),alpha=0.6) +
  geom_vline(xintercept=mean(ASDCancer$CN), size=0.6, color="#F8766D") +
  geom_density(data=neither,aes(x=CN,fill="neither"),alpha=0.6) +
  geom_vline(xintercept=mean(neither$CN), size=0.6, color="#7CAE00") +
  xlab("Copy Number") +
  theme(axis.text.x=element_text(size=13,angle=0,hjust=0.5),
        axis.text.y=element_text(size=13),
        axis.title.x=element_text(size=15),
        ...
        title = element_text(size=20)) +
  theme_bw()
#ggsave("plot/03_CN_phenotype_density.pdf", width = 8, height = 6)  
```

```{r}
ggplot(data=for_CN,aes(x=phenotype,y=CN,fill=phenotype)) +
  ...
  theme(axis.text.x=element_text(size=13,angle=0,hjust=0.5),
        ...
        title = element_text(size=20)) +
  theme_bw()
#ggsave("plot/03_CN_phenotype_boxplot.pdf", width = 8, height = 6)  
```

# CN wilcox test for all sample
...
CN_heat$groups <- cut(CN_heat$`p value`,              
                       breaks = c(1,0.1,0.05,0))

ggplot(data=CN_heat,aes(phenotype1, phenotype2, fill=groups)) + 
    geom_tile() +
    theme_bw() +
    xlab("") +
    ylab("") +
...
ggplot(data=CN_heat_ASD,aes(phenotype1, phenotype2, fill=groups)) + 
    geom_tile() +
    theme_bw() +
  scale_fill_manual(values = c("darkblue","skyblue", "lightblue"), name = "p value", 
                  guide = guide_legend(reverse = TRUE)) +
  theme(axis.text.x=element_text(size=13,angle=0,hjust=0.5),
        ...
        #legend.position = "none",
        title = element_text(size=20))
#ggsave("plot/03_CN_ASD_p.pdf", width = 8, height = 6)
```
...
ggplot(data=CN_heat,aes(phenotype1, phenotype2, fill=groups)) + 
  ...
  theme(axis.text.x=element_text(size=13,angle=0,hjust=0.5),
        ...
        #legend.position = "none",
        title = element_text(size=20))
#ggsave("plot/03_CN_ASD_all_p.pdf", width = 8, height = 6)
...
CN_heat_cancer$groups <- cut(CN_heat_cancer$`p value`,              
                       breaks = c(1,0.1,0.05,0))

ggplot(data=CN_heat_cancer,aes(phenotype1, phenotype2, fill=groups)) + 
    geom_tile() +
    theme_bw() +
...
CN_heat_cancerasd$groups <- cut(CN_heat_cancerasd$`p value`,              
                       breaks = c(1,0.1,0.05,0))

ggplot(data=CN_heat_cancerasd,aes(phenotype1, phenotype2, fill=groups)) + 
    geom_tile() +
    theme_bw() +
  scale_fill_manual(values = c("darkblue","skyblue", "lightblue"), name = "p value", 
                  guide = guide_legend(reverse = TRUE)) +
...
ggplot(data=CN_heat,aes(phenotype1, phenotype2, fill=groups)) + 
    geom_tile() +
    theme_bw() +
  scale_fill_manual(values = c("skyblue","lightblue"), name = "p value", 
                  guide = guide_legend(reverse = TRUE)) +
  ggtitle("log regression results\n-controlling age at constant and sex") +
  theme(axis.text.x=element_text(size=13,angle=0,hjust=0.5),
        axis.text.y=element_text(size=13),
        axis.title.x=element_text(size=15),
        axis.title.y=element_text(size=15),
        ...
        #legend.position = "none",
        title = element_text(size=20))
#ggsave("plot/03_CN_log_regression_sex_age_p.pdf", width = 8, height = 6)
```
...
summary(glm(CN ~ asd_phenotype + SEX + AGCNST,data=temp,family = "binomial"))
summary(glm(CN ~ asd_phenotype + AGCNST,data=temp,family = "binomial"))
summary(glm(CN ~ asd_phenotype + SEX,data=temp,family = "binomial"))
```
